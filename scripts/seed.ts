...
const legalPages = [
  ...
  },
  {
    ...
    body: [
      ...
      textBlock('המידע באתר, לרבות מאמרים, מדריכים ותכנים מקצועיים, מוצג למטרות אינפורמטיביות בלבד ואינו מהווה ייעוץ מקצועי, ייעוץ מס, ייעוץ משפטי או תחליף להתייעצות אישית עם רואה חשבון או יועץ מס מוסמך.'),
...
const aboutPage = {
  _id: 'aboutPage',
  _type: 'aboutPage',
  storyHeadline: 'רואי חשבון מהדור השני — אבי ורון ביטן. מקצועיות, יחס אישי ושירות שלא מתפשר.',
  storyBody: [
    textBlock('אבי ורון ביטן, רואי חשבון, מובילים את משרד ביטן את ביטן מתוך אמונה פשוטה: שירות חשבונאי צריך להיות מקצועי, אישי ונגיש. עם ניסיון משולב של למעלה מ-15 שנה בייעוץ מס, דוחות כספיים וליווי עסקי, אנחנו מלווים לקוחות מכל גודל — מעצמאים ועד חברות בצמיחה.'),
    textBlock('את הבסיס המקצועי הניח שלמה ביטן, רו"ח, שהקים את המשרד המקורי ובנה מוניטין של יושרה ומומחיות. אבי ורון לקחו את הערכים שספגו והוסיפו גישה עדכנית ומענה טכנולוגי — שילוב שמאפשר ללקוחות שקט נפשי מלא.'),
    textBlock('היום, המשרד ממוקם במגדל אלקטרה סיטי בתל אביב ומעניק שירות מקיף: הנהלת חשבונות, ייעוץ מס, דוחות כספיים, ביקורת, מיסוי בינלאומי, ליווי עסקי ושכר. כל לקוח מקבל יחס אישי וזמינות גבוהה — ללא תלות בגודל העסק.'),
  ],
  differentiators: [
    { _key: 'd1', title: 'ניסיון דור שני', description: 'שילוב של ערכים מבוססים עם גישה מקצועית עדכנית — הטוב משני העולמות.', icon: 'shield' },
  ...
  audienceCards: [
    { _key: 'a1', title: 'עצמאים', description: 'פרילנסרים ונותני שירות שרוצים הנהלת חשבונות מסודרת ותכנון מס חכם.', icon: 'user' },
    { _key: 'a2', title: 'עסקים קטנים', description: 'בעלי עסקים שמחפשים שותף פיננסי אמין לניהול השוטף ולצמיחה.', icon: 'store' },
    { _key: 'a3', title: 'חברות בע"מ', description: 'חברות שצריכות ביקורת, דוחות כספיים, ניהול שכר ותכנון מס מקצועי.', icon: 'building' },
    { _key: 'a4', title: 'סטארטאפים', description: 'חברות טכנולוגיה עם צרכים ייחודיים במיסוי בינלאומי וגיוסי הון.', icon: 'rocket' },
  ],
  processSteps: [
  ...
  values: [
    { _key: 'v1', title: 'מקצועיות', description: 'רואי חשבון בעלי הסמכה מלאה, עם ידע מעמיק ועדכני בדיני מס וחשבונאות.', icon: 'award' },
    { _key: 'v2', title: 'אמינות', description: 'שקיפות מלאה, עמידה בלוחות זמנים ומחויבות לטובת הלקוח — בכל פרויקט.', icon: 'handshake' },
    { _key: 'v3', title: 'יחס אישי', description: 'כל לקוח מקבל ליווי צמוד וזמינות גבוהה. אנחנו מכירים כל לקוח בשם.', icon: 'users' },
    { _key: 'v4', title: 'יציבות', description: 'משרד עם בסיס מוצק וניסיון עשיר — יציבות שמעניקה שקט נפשי.', icon: 'building' },
  ],
