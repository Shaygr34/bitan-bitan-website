...
const aboutPage = {
  ...
  storyBody: [
    textBlock('אבי ורון ביטן, רואי חשבון ומשפטנים, שותפים מייסדים של משרד ביטן את ביטן. המשרד מעניק שירותי ראיית חשבון, ייעוץ מס, ביקורת, דוחות כספיים וליווי עסקי מקצועי — לחברות פרטיות, בעלי שליטה ועסקים בכל גודל.'),
    ...
    textBlock('היום, המשרד ממוקם במגדל אלקטרה סיטי בתל אביב ומציע מגוון רחב של שירותים: הנהלת חשבונות, ייעוץ מס, דוחות כספיים, ביקורת, ליווי עסקי, תכנון מס וניהול שכר.'),
  ],
  credentialsNote: 'רואי חשבון ויועצי מס מוסמכים — וגם משפטנים (לא עורכי דין).',
  differentiators: [
...
const siteSettings = {
  ...
  siteDescription:
    'משרד רואי חשבון ביטן את ביטן — רואי חשבון, יועצי מס ומשפטנים. ייעוץ מס, הנהלת חשבונות, דוחות כספיים וליווי עסקי מקצועי בתל אביב.',
  phone: '03-5174295',
  fax: '03-5174298',
