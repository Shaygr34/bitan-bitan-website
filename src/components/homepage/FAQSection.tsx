...
const FALLBACK_FAQS = [
  ...
  { question: 'כמה עולים השירותים?', answer: 'המחיר משתנה בהתאם להיקף השירות ולמורכבות. בפגישת ההיכרות נציג הצעת מחיר מפורטת ושקופה.' },
  { question: 'איך מתחילים לעבוד איתכם?', answer: 'פנו אלינו בטלפון או דרך האתר. נקבע פגישת היכרות, נבין את הצרכים שלכם ונבנה תוכנית עבודה מותאמת.' },
