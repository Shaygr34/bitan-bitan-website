...
const DIFFERENTIATORS = [
  {
    title: 'דור שני של מומחיות',
    description:
      'הידע והניסיון עוברים מדור לדור — שילוב של ותק מקצועי עם גישה חדשנית.',
  },
  {
    title: 'ליווי אישי ומקצועי',
    description:
      'כל לקוח מקבל יחס אישי ומענה מהיר. אנחנו שותפים לדרך, לא רק נותני שירות.',
  },
  {
    title: 'מענה מקיף',
    description:
    ...
    <RevealSection className="bg-surface py-space-9 px-6">
      <div className="max-w-content mx-auto">
        <div className="grid md:grid-cols-2 gap-space-8 items-start">
          {/* Text content */}
          <div>
            <SectionHeader subtitle="משרד רואי חשבון ביטן את ביטן פועל בתל אביב מזה למעלה מ-30 שנה. המשרד מציע שירותי ראיית חשבון, ייעוץ מס וליווי עסקי ללקוחות פרטיים, חברות ועסקים.">
              למה ביטן את ביטן?
            </SectionHeader>
