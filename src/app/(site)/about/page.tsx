...
export const metadata: Metadata = {
  title: 'אודות המשרד',
  description:
    'הכירו את אבי ורון ביטן — רואי חשבון ומשפטנים. ייעוץ מיסוי, ליווי עסקי, דוחות כספיים וביקורת לחברות פרטיות ועסקים.',
  alternates: { canonical: '/about' },
  openGraph: {
    title: 'אודות המשרד — ביטן את ביטן רואי חשבון',
    description:
      'הכירו את אבי ורון ביטן — רואי חשבון ומשפטנים. ייעוץ מיסוי, ליווי עסקי וביקורת.',
  },
}
...
export default async function AboutPage() {
  ...
  const credentialsNote =
    ...
    'רואי חשבון ויועצי מיסוי מוסמכים — וגם משפטנים.'
  ...
  return (
    <>
      <p className="text-body-lg">
        ...
        שירותי ראיית חשבון, ייעוץ מיסוי, ביקורת, דוחות כספיים וליווי עסקי מקצועי —
      ...
      <p>
        ...
        שירותים: הנהלת חשבונות, ייעוץ מיסוי, דוחות כספיים, ביקורת, ליווי עסקי,
        תכנון מס וניהול שכר.
      </p>
    </>
  )
...
const FALLBACK_VALUES = [
  ...
  },
  {
    ...
    title: 'זמינות',
    description:
      'מענה מקצועי ונגיש — בטלפון, במייל או בפגישה.',
    icon: 'headphones',
  },
  {
    _key: 'v4',
