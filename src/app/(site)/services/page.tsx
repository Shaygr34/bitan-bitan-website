...
export const metadata: Metadata = {
  title: 'השירותים שלנו',
  description:
    'שירותי ראיית חשבון, ייעוץ מיסוי, הנהלת חשבונות, דוחות כספיים, ביקורת, ליווי עסקי ומיסוי בינלאומי — ביטן את ביטן.',
  alternates: { canonical: '/services' },
  openGraph: {
    title: 'השירותים שלנו — ביטן את ביטן רואי חשבון',
    description:
      'שירותי ראיית חשבון, ייעוץ מיסוי, הנהלת חשבונות, דוחות כספיים, ביקורת וליווי עסקי.',
  },
};
...
const FALLBACK_SERVICES = [
  { icon: Calculator, title: "ייעוץ מיסוי", description: "תכנון מס אסטרטגי ליחידים, חברות ועסקים — חיסכון מקסימלי במסגרת החוק.", details: ["תכנון מס שנתי ורב-שנתי", "ייעוץ בעסקאות מורכבות", "תכנון מס לפני מכירת נכסים או עסק", "ייצוג מול רשויות המס", "החזרי מס לשכירים"] },
