...
const FALLBACK_GROUPS = [
  {
    ...
    items: [
      ...
      { q: 'כמה עולים השירותים?', a: 'המחיר משתנה בהתאם להיקף השירות ולמורכבות. בפגישת ההיכרות נציג הצעת מחיר מפורטת ושקופה.' },
      { q: 'איך מתחילים לעבוד איתכם?', a: 'פנו אלינו בטלפון או דרך האתר. נקבע פגישת היכרות, נבין את הצרכים שלכם ונבנה תוכנית עבודה מותאמת.' },
