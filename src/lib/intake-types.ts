...
/** Summit תחום עיסוק entity IDs (folder 1081738742) — 25 canonical categories */
export const BUSINESS_SECTOR_IDS: Record<string, number> = {
...
/** Summit מנהל תיק entity IDs (folder 1081739389) */
export const ACCOUNT_MANAGER_IDS: Record<string, number> = {
  'אבי ביטן': 1081753575,
  'רון ביטן': 1081754061,
}

/** Summit עובד/ת ביקורת entity IDs (folder 1081740413) */
export const AUDIT_WORKER_IDS: Record<string, number> = {
  'אבי ביטן': 1099334847,
  'גיא מחאני': 1099335750,
  'חיה כהן גבורה': 1099335784,
  'יצחק ביטן': 1099336153,
  'משי כהן': 1099336180,
  'רון ביטן': 1099336636,
  'שי גרייבר': 1099337096,
  'הודיה יוסף': 1099337428,
  'נלה פרידמן': 1099339185,
}

// מנהל תיק comes from intake token (set during link generation in OS)
